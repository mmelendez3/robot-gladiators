...
var fight = function(enemyName) {
  ...
  var startGame = function() {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        ...
        //if a player is still alive and we're not a the last enemy in the array
    ...
    var endGame = function() {
        ...
        if (playerHealth > 0) {
            window.alert("Great job, you've survived the game! You now have a score of " + playerMoeny + ".");
        }
        else {
